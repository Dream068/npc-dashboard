...
import { bankOptions, listMerchantColumns, listMerchantRows } from '../constants/mockdata';
  ...
  return (
    <div className={classes.contentRoot}>
      <div className={classes.title}>
        <Typography variant="h4" color="primary">{t('merchant_management')}</Typography>
        <Typography variant="h3" color="primary" className={classes.transactionTitle}>{t('merchant_list')}</Typography>
      </div>
      ...
      <div className={classes.search}>
        ...
        <InputBase
          placeholder={t('search_by_merchant')}
          classes={{
      ...
      <div className={classes.filterGroup}>
        <Select
          options={bankOptions}
          placeholder={t('by_bank')}
          className={classes.merchantSelect}
        />
        <Select
          options={bankOptions}
          placeholder={t('by_capital')}
          className={classes.merchantSelect}
        />
      ...
      <div className={classes.grid}>
        <DataGrid
          ...
          pageSize={8}
          pagination
          rows={listMerchantRows}
          columns={listMerchantColumns}
        />
      </div>
    </div>
  );
